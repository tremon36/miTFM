...
MODEL                   = sigmadelta_full_DCO_Sampled_differential_integer_true
MODULES                 = rtGetInf.c rtGetNaN.c rt_nonfinite.c sigmadelta_full_DCO_Sampled_differential_integer_true.c sigmadelta_full_DCO_Sampled_differential_integer_true_capi.c sigmadelta_full_DCO_Sampled_differential_integer_true_data.c sigmadelta_full_DCO_Sampled_differential_integer_true_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = sigmadelta_full_DCO_Sampled_differential_integer_true.exe
MAKEFILE                = sigmadelta_full_DCO_Sampled_differential_integer_true.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023b
START_DIR               = C:\miTFM\modelos_matlab\integer_true
S_FUNCTIONS_LIB         = 
NUMST                   = 4
NCSTATES                = 12
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = sigmadelta_full_DCO_Sampled_differential_integer_true_ref.rsp
COMPILER_COMMAND_FILE     = sigmadelta_full_DCO_Sampled_differential_integer_true_comp.rsp
